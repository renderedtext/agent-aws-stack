...
class AwsSemaphoreAgentStack extends Stack {
  ...
  createAutoScalingGroup(launchTemplate) {
    ...
    const onDemandBaseCapacity = this.argumentStore.get("SEMAPHORE_AGENT_ON_DEMAND_BASE_CAPACITY");
    const onDemandPercentageAboveBase = this.argumentStore.get("SEMAPHORE_AGENT_ON_DEMAND_PERCENTAGE_ABOVE_BASE");
