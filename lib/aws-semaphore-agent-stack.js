...
class AwsSemaphoreAgentStack extends cdk.Stack {
  ...
  createStarterLambda(lambdaRole) {
    ...
    let lambdaFunction = new lambda.Function(this, 'starterLambda', {
  ...
  createScalerLambda(lambdaRole) {
    ...
    let lambdaFunction = new lambda.Function(this, 'scalerLambda', {
  ...
  createEventRuleForScaler(lambda) {
    ...
    const rule = new events.Rule(this, 'scalerRule', {
      description: `Rule to dynamically invoke lambda function to scale semaphore agent`,
  ...
  createStarterRule(lambda) {
    ...
    let rule = new events.Rule(this, 'starterRule', {
  ...
  createLaunchConfiguration(iamInstanceProfile, securityGroups, hasWarmPool) {
    ...
    if (!hasWarmPool) {
      ...
      launchConfig.userData = cdk.Fn.base64(userData.render())
    }
  ...
  createWarmPool(autoScalingGroup) {
    new autoscaling.CfnWarmPool(this, 'warmPool', {
