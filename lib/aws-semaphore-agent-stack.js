...
class AwsSemaphoreAgentStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    /**
     * The lambda function needs information about the agent in order to install it.
     * The only way for it to grab that information is through an SSM Parameter.
     *
     * Note that this creates a tight coupling between this script and the lambda script,
     * as both of them need to use the proper parameter name and structure. So, if you
     * change anything about the SSM Parameter, the lambda will probably need to change as well.
     */
