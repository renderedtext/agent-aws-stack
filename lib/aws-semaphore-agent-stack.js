...
class AwsSemaphoreAgentStack extends Stack {
  ...
  createScalerLambda(lambdaRole) {
    ...
    this.createLambdaLogGroup('scalerLambdaLogGroup', lambdaFunction);
  ...
  createAzRebalanceSuspender(autoScalingGroup) {
    ...
    this.createLambdaLogGroup('azRebalanceSuspenderLambdaLogGroup', suspenderFunction);

    const provider = new Provider(this, "azRebalanceSuspenderProvider", {
      onEventHandler: suspenderFunction,
      logGroup: new LogGroup(this, 'azRebalanceSuspenderProviderLogGroup', {
  ...
  createLambdaLogGroup(id, lambdaFunction) {
