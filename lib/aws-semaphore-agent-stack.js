  ...
  createScalerLambda(lambdaRole) {
    ...
    let opts = {
      ...
      environment: {
        ...
        "SEMAPHORE_OVERPROVISION_STRATEGY": this.argumentStore.get("SEMAPHORE_AGENT_OVERPROVISION_STRATEGY"),
        "SEMAPHORE_OVERPROVISION_FACTOR": this.argumentStore.get("SEMAPHORE_AGENT_OVERPROVISION_FACTOR"),
      }
    }
